...
RUN /opt/conda/bin/python -m pip install torch==2.1.2 torchvision==0.16.2 torchaudio==2.1.2 --index-url https://download.pytorch.org/whl/cu121

RUN git clone https://github.com/edwardpwtsoi/StyleTTS2
RUN /opt/conda/bin/python -m pip install -r StyleTTS2/requirements.txt
